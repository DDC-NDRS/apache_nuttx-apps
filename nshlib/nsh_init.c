...
#if defined(CONFIG_NSH_READLINE) && defined(CONFIG_READLINE_TABCOMPLETION) && defined(CONFIG_READLINE_HAVE_EXTMATCH)
...
extern int const             CONFIG_NSH_SYMTAB_COUNTNAME;
#endif
...
void nsh_initialize(void) {
    ...
    #if defined(CONFIG_NSH_TELNET) && !defined(CONFIG_NSH_DISABLE_TELNETSTART) && !defined(CONFIG_NETINIT_NETLOCAL)
