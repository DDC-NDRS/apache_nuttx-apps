...
static char const button_name[CONFIG_EXAMPLES_BUTTONS_QTD][16] = {CONFIG_EXAMPLES_BUTTONS_NAME0
...
int main(int argc, FAR char* argv[]) {
    ...
    ret = task_create("button_daemon", CONFIG_EXAMPLES_BUTTONS_PRIORITY, CONFIG_EXAMPLES_BUTTONS_STACKSIZE,
                      button_daemon, NULL);
    if (ret < 0) {
        int errcode = errno;
